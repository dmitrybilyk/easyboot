package com.learn.easyboot.bases.generics.crazy;
...
public class CrazyGenerics {
     ...
     */
    public interface StrictProcessor { // todo: make it generic
     ...
     */
    public interface CollectionRepository { // todo: update interface according to the javadoc
     ...
     * @param <T> – a type of the entity that should be a subclass of {@link BaseEntity}
     */
    public interface ListRepository { // todo: update interface according to the javadoc
    }
     ...
     */
    public interface ComparableCollection { // todo: refactor it to make generic and provide a default impl of compareTo
    }
