package com.learn.easyboot.bases.patterns.creational.singleton.issues.synchro_overhead;
...
//    SOLUTION >> to make getInstance() synchronized
    public static SingletonTestClass getInstance(){
        ...
        if (sSoleInstance == null) { //Check for the first time
            ...
            synchronized (SingletonTestClass.class) {   //Check for the second time.
                //if there is no instance available... create new one
                if (sSoleInstance == null) sSoleInstance = new SingletonTestClass();
            }
        }
